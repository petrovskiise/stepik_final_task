...
class BasketPage(BasePage):
    ...
    def should_be_empty_basket_message(self):
        assert self.is_element_present(
            *BasketPageLocators.EMPTY_BASKET_MESSAGE), "The empty basket message is not present"

    def should__be_continue_shopping_link(self):
        assert self.is_element_present(
            *BasketPageLocators.CONTINUE_SHOPPING_LINK), "The continue shopping link is not present"
